  ...
  return (
    <section className="relative min-h-screen flex items-end md:items-center justify-center overflow-hidden">
      ...
      <picture className="absolute inset-0 w-full h-full">
        ...
        <source media="(max-width: 767px)" srcSet={hero.heroImageMobile} />
      ...
      <div className="absolute inset-0 bg-black/70 md:bg-black/58"></div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 pt-24 pb-16 md:py-24 text-center">
        ...
        <div className="inline-flex items-center gap-3 mb-8">
          ...
          <span className="text-[#c9965b] tracking-[0.2em] uppercase text-sm">{hero.eyebrow}</span>
          <div className="w-12 h-[1px] bg-[#c9965b]"></div>
        </div>
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl mb-8 text-[#f5f5f0] tracking-tight max-w-4xl mx-auto font-display font-light leading-[1.1]">
          {hero.headlinePart1}{' '}
          <span className="italic text-[#c9965b]">{hero.headlineItalic}</span>
        </h1>
